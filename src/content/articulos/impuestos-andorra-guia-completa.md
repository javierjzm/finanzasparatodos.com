...
keywords:
  ...
  - fiscalidad andorra
  - IRPF andorra
  - mudarse a andorra impuestos
  - residencia fiscal andorra
  - comparar impuestos españa andorra
  - CASS andorra
  - IGI andorra
...
En esta guía analizamos en detalle todos los impuestos de Andorra, los requisitos para establecer tu residencia fiscal allí y cuánto podrías ahorrar realmente. Si quieres ver los números al instante, usa nuestra **[calculadora fiscal España vs Andorra](/calculadora-fiscal/)**.
...
| Impuesto | Tipo | Detalle |
|----------|------|---------|
| IRPF | 0 %, 5 % y 10 % | Tres tramos progresivos |
| CASS (Seg. Social) | 6 % - 16 % | Asalariados 6 %, autónomos 16 % |
| IGI (IVA) | 4,5 % | El más bajo de Europa |
| I. Sociedades | 10 % | Tipo único |
| I. Patrimonio | 0 % | No existe |
| Sucesiones | 0 % | No existe |
...
Esto contrasta enormemente con los [tramos del IRPF en España](/irpf/tramos-irpf-2025/), donde el tipo marginal máximo llega al 47 % (y hasta el 54 % en algunas comunidades autónomas).
...
| Salario bruto | Neto España | Neto Andorra | Ahorro/año | Ahorro 10 años |
|--------------|-------------|--------------|------------|----------------|
...
Para calcular tu caso concreto con distintos países, comunidades autónomas y situaciones familiares, utiliza nuestra **[calculadora fiscal España vs Andorra](/calculadora-fiscal/)**.

## Requisitos para ser residente fiscal en Andorra

Para trasladar tu [residencia fiscal](/fiscalidad-internacional/residencia-fiscal-espana/) al Principado, necesitas cumplir varios requisitos:

1. **Permiso de residencia:** Existen distintos tipos (activa, pasiva, por cuenta propia). La residencia pasiva requiere una inversión mínima de 600.000 € en Andorra y un depósito de 47.500 € en la AFA.
...
No solo desde España compensa mudarse a Andorra. También se ahorra significativamente desde Francia, Italia, Alemania o Reino Unido. Nuestra [calculadora](/calculadora-fiscal/) permite comparar desde 7 países distintos.

Si estás valorando la inversión como vía de ingresos en Andorra, te interesa conocer la [fiscalidad de los fondos de inversión](/inversiones/fondos-inversion-fiscalidad/) y cómo tributan las plusvalías en cada país.
